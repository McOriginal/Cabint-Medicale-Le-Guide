...
import { useOneExterneOrdonnance } from '../../Api/queriesExterneOrdonnance';
...
export default function Ordonnance() {
  ...
  } = useOneExterneOrdonnance(param.id);
                ...
                <CardBody className='text-info'>
                  ...
                  <div className='d-flex justify-content-between align-items-center my-3 '>
                    <div className='font-size-12'>
                      <p className='my-1'>
                        <strong> Nom:</strong>{' '}
                        {capitalizeWords(selectedOrdonnanceData?.patient)}{' '}
                      </p>
                      <p className='my-1'>
                        <strong> Diagnostic:</strong>{' '}
                        {capitalizeWords(selectedOrdonnanceData?.traitement)}
                      </p>
                    </div>
                    <div className='font-size-12'>
                      <p className='my-1'>
                      ...
                      {selectedOrdonnanceData?.items?.map((item, index) => (
                        ...
                        >
                          <p>
                            ...
                            {' : '}
                            {capitalizeWords(item?.medicament)}
                            <span className='mx-2'>
                              <strong>
